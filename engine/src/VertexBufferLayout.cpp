...
void VertexBufferLayout::CreatePositionBufferLayout(unsigned int vcount,
                                                    unsigned int icount,
                                                    float* vdata,
                                                    unsigned int* idata) {
  ...
  glGenBuffers(1,
               &m_vertexPositionBuffer);  // selecting the buffer is
  ...
  glVertexAttribPointer(
      0,         // Attribute 0, which will match layout in shader
...
void VertexBufferLayout::CreateTextureBufferLayout(unsigned int vcount,
                                                   unsigned int icount,
                                                   float* vdata,
                                                   unsigned int* idata) {
  ...
  // - Make sure you use a new attribute(i.e. 0 is already used for position
  // data!)
  // - Make sure the correct offset is set (i.e. the starting point of the color
  // data)
...
void VertexBufferLayout::CreateNormalBufferLayout(unsigned int vcount,
                                                  unsigned int icount,
                                                  float* vdata,
                                                  unsigned int* idata) {
  m_stride = 14;
